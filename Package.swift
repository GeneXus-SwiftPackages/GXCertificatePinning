...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.24.xcframework.zip",
			checksum: "7c63ee93ddf25b797a7630bf5b6240f02313bfe2066e99e324c52cdfdc50f675"
		)
	]
)