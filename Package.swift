...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.2.0.xcframework.zip",
			checksum: "2e8315c086662c8a94796383abfdfc47b004121039b41677fde7ecb391a4bd93"
		)
	]
)