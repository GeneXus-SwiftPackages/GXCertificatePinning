...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.13.xcframework.zip",
			checksum: "55ced8bce773875ca6d8ddd94a36542f8f96402b314df3fc81ffb5abc2b44e9f"
		)
	]
)