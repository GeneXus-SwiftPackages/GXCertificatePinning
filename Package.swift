...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.22.xcframework.zip",
			checksum: "08946c447b56a32442bda0ab43bf0de98e89b0e3cbd7dcf03aca470db23ac561"
		)
	]
)