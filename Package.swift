...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.6.0-beta.2.xcframework.zip",
			checksum: "1ce92be48c290b6817d85021a0898239996e08cfa798cd06f816594a6e91d370"
		)
	]
)