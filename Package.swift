...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.13.xcframework.zip",
			checksum: "b2ae6863196724d349d4ebad42ec20340eb1e578ec3a4293f6504f46fb686007"
		)
	]
)