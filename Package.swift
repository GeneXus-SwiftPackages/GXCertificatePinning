...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.13.xcframework.zip",
			checksum: "a5b4d87f96a0ca8d138a83cade22d0f18dcf5f140acd0c06591a3cd22e87e9a3"
		)
	]
)