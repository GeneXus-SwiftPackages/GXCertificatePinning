...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.1.0-rc.22.xcframework.zip",
			checksum: "8b87126c23f8c7e7f28e63df79d93b2c172107723b776f8975d510ab102c860c"
		)
	]
)