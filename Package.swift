...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.0.4.xcframework.zip",
			checksum: "34adaf993f4e40e787bd2ead2bed70b8ac265a7fefba48101b35a1c206ca1705"
		)
	]
)