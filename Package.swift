...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-5.0.0-beta.4.xcframework.zip",
			checksum: "0bc4036ffc5609579b11e0060fbf32856fff87b82a6f7c5b8af1276f798f4733"
		)
	]
)