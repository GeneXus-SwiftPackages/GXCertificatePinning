...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.29.xcframework.zip",
			checksum: "0dc59fc4341d67e06571186f4d261ac290aeef3dde8717939e5197c6ef85a77c"
		)
	]
)