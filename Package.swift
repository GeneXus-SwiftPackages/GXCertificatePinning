...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.4.xcframework.zip",
			checksum: "1b8cd91e75b31b033d33799f95065e8c9240ca1c6c82e07a3cc03030fd903f5e"
		)
	]
)