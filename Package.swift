...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.1.0-beta.26.xcframework.zip",
			checksum: "a71b6d82588d96fa773d12f380b5b14fa1e9c91f5f98dc21efe44abf3cbdf0be"
		)
	]
)