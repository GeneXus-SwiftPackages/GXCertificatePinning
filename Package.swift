...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.23.xcframework.zip",
			checksum: "ad14ecb3c24ac4c7c44bf20f98eb4459f7ef0fe6a8852ca5051d254e40fb4df4"
		)
	]
)