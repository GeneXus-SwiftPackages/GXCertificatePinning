...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.39.xcframework.zip",
			checksum: "a89744e0b6d65a676ecbfea42d6271eace43038a8ff5f11763a05ada24be7094"
		)
	]
)