...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.37.xcframework.zip",
			checksum: "23c06683f8bd7f32c76f9e8b2cc3ae786b5fd0da75148c9fabd68a44a7e79577"
		)
	]
)