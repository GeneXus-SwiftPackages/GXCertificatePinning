...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.6.xcframework.zip",
			checksum: "9a95aa9b6fc111fcecf51d34750d55c289409dd72e2addc8918cb9f1899ef462"
		)
	]
)