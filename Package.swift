...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.32.xcframework.zip",
			checksum: "fc0261559392b2742171726f51b04b23165a1525a94eb50dc5683d34e553bb2c"
		)
	]
)