...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.20.xcframework.zip",
			checksum: "4ab3e2a83dcdd811aa1063cb8aa0983f960148193c3ec8f67f314f54d9d77d6d"
		)
	]
)