...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.21.xcframework.zip",
			checksum: "e9a2dffab70a51a5293a1eaac42b0a03da867875b2f1099b621293a7c7e60fa3"
		)
	]
)