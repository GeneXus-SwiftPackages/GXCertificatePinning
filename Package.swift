...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.1.1.xcframework.zip",
			checksum: "b7d71e5b2ff9db33edf0b82e52bc46d9a1eaeb0815018e49b3940f6039a105ac"
		)
	]
)