...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-5.0.0-beta.6.xcframework.zip",
			checksum: "d16f6609a64b66c9080bfad6b63d5f6550a84464a274efaac4acdf8f0c534870"
		)
	]
)