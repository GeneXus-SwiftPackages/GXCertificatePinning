...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.9.xcframework.zip",
			checksum: "890c9867c918dd90e3f738584b9bc78fcb7c56b8c7b364f145ce455eff181e07"
		)
	]
)