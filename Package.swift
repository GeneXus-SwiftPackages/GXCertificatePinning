...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.24.xcframework.zip",
			checksum: "3234055a321660ce7f0adb35551bb67140199b449023000a4d1cdbe102f71e76"
		)
	]
)