...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.33.xcframework.zip",
			checksum: "5c4a6f7837a2b09f8c823f287e1079df3dcdbec5b26919092e4b2e57cfd518ae"
		)
	]
)