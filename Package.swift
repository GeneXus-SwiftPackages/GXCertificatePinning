...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.17.xcframework.zip",
			checksum: "9df1b7a4eebf6c6d61dab95cf38fc6755541ae1435d9bbdae26d23c5b6101675"
		)
	]
)