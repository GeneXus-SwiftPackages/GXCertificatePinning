...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-5.0.0-rc.1.xcframework.zip",
			checksum: "e85b3f7e70241d80daee5feeb8e65f8e0ad236a092278c97d5631757ad99baad"
		)
	]
)