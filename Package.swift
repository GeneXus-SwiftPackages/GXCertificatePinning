...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.0.0.xcframework.zip",
			checksum: "54941d4665d225a32020926d53ff7aad2fe1a84689aa4a0816779e0a91eaf2c9"
		)
	]
)