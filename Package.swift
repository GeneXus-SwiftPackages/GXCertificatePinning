...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.0.3.xcframework.zip",
			checksum: "e288d7ee15184cb8af1ba7532125a9c7a4c6256490e81f2fceac1e8d66482a7b"
		)
	]
)