...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.2.xcframework.zip",
			checksum: "596094bc2f6662dc0f930556b767a5970243f5be6f8723bf6c7cfc4d797bd775"
		)
	]
)