...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.22.xcframework.zip",
			checksum: "e2fb22fceae69ca4f51e40c7cdfbd00cbf38a6d75fa7aab5897f25bc9730f940"
		)
	]
)