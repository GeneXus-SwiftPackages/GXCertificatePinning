...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.35.xcframework.zip",
			checksum: "72da708d4660b8ac74c208de611760bea79460b0f615c8f9421d92d124d0f6d5"
		)
	]
)