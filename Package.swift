...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.24.xcframework.zip",
			checksum: "9e27553970c6b1af0a1f821442644bb2ed927aec9a64f4215fce3ec3a35dae14"
		)
	]
)