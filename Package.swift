...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.3.xcframework.zip",
			checksum: "f53cdf7cd07e849c5a78eede8dc338f85c07cab60f9e390ed4d97fec2b4ceeeb"
		)
	]
)