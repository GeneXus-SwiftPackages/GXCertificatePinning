...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.24.xcframework.zip",
			checksum: "6fe052df15a1c6dd92493c2834dbff736ab68b7f9537989028818713bb5ead51"
		)
	]
)