...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.2.0-rc.12.xcframework.zip",
			checksum: "1502b2493194459d8c92cbc158a07a04850028620d1c70b5f85a3b5aef59eb5c"
		)
	]
)