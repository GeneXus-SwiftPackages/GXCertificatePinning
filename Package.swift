...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.7.xcframework.zip",
			checksum: "f406128fbb186bd93a785e5bf52cdcc6bec0ac8d106fa1e1e61e20027f7c7b2f"
		)
	]
)