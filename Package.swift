...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.34.xcframework.zip",
			checksum: "3db7c93d2195c1fee4efd797fed8f7a222fa75a2cb5f3d224d04379f808e2689"
		)
	]
)