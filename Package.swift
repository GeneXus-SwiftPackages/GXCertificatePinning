...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.11.xcframework.zip",
			checksum: "495f07a84853aacff343db5a4060f07f0dc5cfbbeb1d8e361c21d5da6d011ed8"
		)
	]
)