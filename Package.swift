...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.6.xcframework.zip",
			checksum: "4836af01dfe43687ff522d39530c1d4fa28d897de7c77954964eeff208d59a90"
		)
	]
)