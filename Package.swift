...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.1.0-rc.3.xcframework.zip",
			checksum: "e31b4729b8c5ba9a863833f6b47dc7271e5fc2fd4bf33fffb1f39e252e549363"
		)
	]
)