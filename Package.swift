...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.15.xcframework.zip",
			checksum: "61a27d002c9d01694df8b7acb14fa6b7c83fdcfcd698007c4dbb7d0de2cb34ab"
		)
	]
)