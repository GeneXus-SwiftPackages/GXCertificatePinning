...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.32.xcframework.zip",
			checksum: "32d50f217df48fa2128ff88a1f6b337578764d8ba9624d7e4f660f35d8a6a1e8"
		)
	]
)