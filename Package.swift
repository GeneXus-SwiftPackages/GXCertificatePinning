...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.0.0-rc.0.xcframework.zip",
			checksum: "5e1ef61ac5e01583cd2b2dadeaf5d511bda410e472f68ac30bd8835b416eac92"
		)
	]
)