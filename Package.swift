...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.4.27.xcframework.zip",
			checksum: "8a67dd91786f37ee620d233736f55fa3c37735526bfdc23b0dced94e5c4e21a8"
		)
	]
)