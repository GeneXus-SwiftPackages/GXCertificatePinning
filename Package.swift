...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.30.xcframework.zip",
			checksum: "d95143c42ad840a4f6038b2366c94f2f3f493bac29927e090f468df29b613027"
		)
	]
)