...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.16.xcframework.zip",
			checksum: "f1782142fb9b76d26c86bf6c6061953138a388fad36e0b152c461968651bb198"
		)
	]
)