...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.19.xcframework.zip",
			checksum: "bc0d4e7bc6420c04a06c259543ebeba57960c97090559b6ab4269c2b52912d9f"
		)
	]
)