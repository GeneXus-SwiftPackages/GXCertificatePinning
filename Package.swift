...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.3.6.xcframework.zip",
			checksum: "787e669e69ee5735b391c67de09757b8e07afb16b08be451585dd821bc18fc52"
		)
	]
)