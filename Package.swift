...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.0.0-rc.43.xcframework.zip",
			checksum: "e7eaeb2ca26d8d86c39f0c1ff4dc0baa465c8cca3f760be1eaae79f38afd51c3"
		)
	]
)