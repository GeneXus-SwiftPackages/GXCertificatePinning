...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.20.xcframework.zip",
			checksum: "d4d0deae487a67e3c9f0311dc235ff56b3a46a8b297f36819985db91ca63def8"
		)
	]
)