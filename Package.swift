...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.17.xcframework.zip",
			checksum: "8d92d77b8852359ead081897d8337521e7083846518622f2b4f9628b3bb4a3a6"
		)
	]
)