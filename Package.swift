...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.16.xcframework.zip",
			checksum: "3d00123d6578b5d80013016b89f989f1b0beca96e6c65372670f2ffdeee82cc2"
		)
	]
)