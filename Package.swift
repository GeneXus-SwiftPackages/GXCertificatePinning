...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.22.xcframework.zip",
			checksum: "68651a05390586274706277fe827209f258ae5b1c0ada8fcb767abf74ce3a346"
		)
	]
)