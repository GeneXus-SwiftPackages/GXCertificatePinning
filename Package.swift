...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.8.xcframework.zip",
			checksum: "c82e3fd8259819aec0e01e17cb2576402517f9831da6a9b1478da5c15bfcad97"
		)
	]
)