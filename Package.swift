...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.5.17.xcframework.zip",
			checksum: "ece0512f51a02dda01f844fb2eb7145a4569b1ad9506b54d2f408239ad0708a6"
		)
	]
)