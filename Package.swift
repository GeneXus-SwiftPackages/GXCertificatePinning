...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.9.xcframework.zip",
			checksum: "d44995eef1e5e2eafc061948de56a9dbad8eb2dd3416b752eb688e8a7dcc807a"
		)
	]
)