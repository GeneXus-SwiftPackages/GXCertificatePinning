...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "142797ef5b84b35dbf4beda3c5ad829e57380c26ea022b4874fecd38db43b586"
		)
	]
)