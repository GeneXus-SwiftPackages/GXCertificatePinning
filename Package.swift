...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.12.xcframework.zip",
			checksum: "ef433a5a74ec002052c65f810d6e55c0852f4c3b392785325b34156fdf717aea"
		)
	]
)