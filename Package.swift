...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.13.xcframework.zip",
			checksum: "c1e1c18b71c59e9edcccf22c3c2bf4ba4f6554af1e1a69a52438557e6a0b636c"
		)
	]
)