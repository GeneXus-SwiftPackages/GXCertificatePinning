...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230525135158.xcframework.zip",
			checksum: "ae1ed9b9319506fe6318e9c64f1ddb7e9da302cf25376ed7eb91d8872609b8a0"
		)
	]
)