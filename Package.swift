...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.5.xcframework.zip",
			checksum: "4953780b50c5112e02c150975353280ed1ee0c3f3d5335edc2d2994a0bbf012f"
		)
	]
)