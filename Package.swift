...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.30.xcframework.zip",
			checksum: "5f3e814b855c67d79a925295a96832ebec95850caccd948156f5c33b61d98876"
		)
	]
)