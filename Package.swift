...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-2.0.18.xcframework.zip",
			checksum: "f25f35fe53d279b32e4d7729632edde72c91d993d1152770b221b3940c6a5273"
		)
	]
)