...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.2.0.xcframework.zip",
			checksum: "42b08de9ce65fe81005e93ce6ff1844ecabd608edc2430a52cb807049e5e6e17"
		)
	]
)