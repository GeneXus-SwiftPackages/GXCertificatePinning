...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.0.0-beta.49.xcframework.zip",
			checksum: "466b0b2823859b11b73ad1db2633a8ab97dea149a149a58a4c1b45c1a3545569"
		)
	]
)