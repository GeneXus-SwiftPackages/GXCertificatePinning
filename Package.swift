...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.23.xcframework.zip",
			checksum: "8c2e3150fca386ac4afa4aba95dcd01aacaa4ec381d10adb7c81d1deac57fb20"
		)
	]
)