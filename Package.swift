...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.0.7.xcframework.zip",
			checksum: "eb96fe93121da0be94313b461f4d5d7d54abbd89c22e0f51c0294a79863d8fa0"
		)
	]
)