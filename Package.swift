...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.3.0.xcframework.zip",
			checksum: "28978e892104c6f6199b14db7343f73f98bee9201e1ed1878484ea7a10c99e0d"
		)
	]
)