...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.6.xcframework.zip",
			checksum: "1bd65bbb91491044e588438694d277067a704e878e03614fc6cd452173473006"
		)
	]
)