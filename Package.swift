...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.22.xcframework.zip",
			checksum: "5e5af03e20e5e8f6d7049310e16e1f155b3a34164f26bff348be000927862579"
		)
	]
)