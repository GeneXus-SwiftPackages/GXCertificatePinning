...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.5.0-rc.28.xcframework.zip",
			checksum: "9125923bea34acaf8792e6600a518f21144af38997cb40e0bdf5ad95e0dd3d25"
		)
	]
)