...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.24.xcframework.zip",
			checksum: "44d412aa5eed23b1978198cad1fd2f476e7939b780d0fc7c55a768243c6f43d2"
		)
	]
)