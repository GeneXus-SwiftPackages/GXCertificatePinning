...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.31.xcframework.zip",
			checksum: "f87432559d73987a791d9c54ac9ac4f297c1405eec9f36abb94b446537222c5a"
		)
	]
)