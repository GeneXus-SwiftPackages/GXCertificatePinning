...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.13.xcframework.zip",
			checksum: "ccd019c82bcecddb001b817f35c3519d9553e03699cc275d287dd10f12891617"
		)
	]
)