...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.2.0-rc.11.xcframework.zip",
			checksum: "aa2a061c8683360a17459adaa291985287d5b196de02e659ba1bb75b123b2dce"
		)
	]
)