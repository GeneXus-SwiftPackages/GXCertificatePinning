...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.10.xcframework.zip",
			checksum: "a2f129a56e90e6a29619974fea1eb7e8404069967f4348f8a9a7bd57eecc9fe6"
		)
	]
)