...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.2.0-rc.29.xcframework.zip",
			checksum: "0b76cdc7432085d02c5897b9ecc879a657d9b8667335471314e03f1013bcd335"
		)
	]
)