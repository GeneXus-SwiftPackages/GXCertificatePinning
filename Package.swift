...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.0.0-beta.48.xcframework.zip",
			checksum: "7735f55250ded3e9704c470839fdf420fafe7abd7b7258039d1c94301397d37f"
		)
	]
)