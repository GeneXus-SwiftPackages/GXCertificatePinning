...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.4.xcframework.zip",
			checksum: "478fb6eecc5e306848b3f9062becfa90030dddfa4900f8b203b6138f980b232d"
		)
	]
)