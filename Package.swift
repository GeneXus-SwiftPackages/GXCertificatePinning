...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.0.0.xcframework.zip",
			checksum: "63f84a684f5cfea1bddd97969a075d4486d2acaa94ade87e7acdbe1b1ad311f5"
		)
	]
)