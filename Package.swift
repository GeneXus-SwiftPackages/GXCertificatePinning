...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.1.xcframework.zip",
			checksum: "78d01d3145cac6f5ab972de2717e9e775bcd5d3c0713f4348470b02c852e3a8b"
		)
	]
)