...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.2.xcframework.zip",
			checksum: "a8b4b589905ea8cf962d778a60ef04a2b058c300d88c16df6b473b8437148cab"
		)
	]
)