...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230309134517.xcframework.zip",
			checksum: "15db8c776ba4ee80ccf295275439fd29ffcdcd12c97425cd48471621e1e8931f"
		)
	]
)