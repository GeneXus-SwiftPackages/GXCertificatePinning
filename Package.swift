...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "0cf24fc934c750572208fab20594300b048093c97636b15a55bcf04f5a5edf72"
		)
	]
)