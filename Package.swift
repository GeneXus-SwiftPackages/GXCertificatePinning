...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.3.0-beta.7.xcframework.zip",
			checksum: "947658b0239e3f042d50b2f4da6ac9951e987e26ca23290b51bfecdf15b1854e"
		)
	]
)