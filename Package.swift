...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.33.xcframework.zip",
			checksum: "fd67f8c8d35200acad0a9695529b5c132da3a598972a5604a59b50ebd3324377"
		)
	]
)