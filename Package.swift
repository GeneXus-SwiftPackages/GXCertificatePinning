...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.9.xcframework.zip",
			checksum: "29babb4fe0905bf5cd4c90521e2951d4a8e0d24774e6307684ffd6627e5dbd70"
		)
	]
)