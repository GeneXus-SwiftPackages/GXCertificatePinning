...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.35.xcframework.zip",
			checksum: "de8a09c5f0c0faf1dcb558ebfb20cc9b070400c8caf2343f44cfeae19d3a3129"
		)
	]
)