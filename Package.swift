...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.14.xcframework.zip",
			checksum: "a429c94448274871e163fb1497df537261fff580ffb2474a45d8935d760a190c"
		)
	]
)