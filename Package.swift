...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.26.xcframework.zip",
			checksum: "063da96609d93ba951204e9e4fa47b1e531fb6cd65d6cf75f4cde5e8aed481ab"
		)
	]
)