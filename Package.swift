...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.0.xcframework.zip",
			checksum: "525c10d2a5520eafdae7c816fed61b1ea50626cfc5521036afe46a6309a3d95b"
		)
	]
)