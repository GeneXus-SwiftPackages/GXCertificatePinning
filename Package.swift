...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.22.xcframework.zip",
			checksum: "827f6175b94570c8a48a81a7a4817a54b6427d5584c85a22c2ad5b64ae01cbc6"
		)
	]
)