...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-2.0.0-rc.36.xcframework.zip",
			checksum: "6b0f358d2bc7fbbb272b7e0595dbbbc853b99c3d5306abfce3564a52eb1183eb"
		)
	]
)