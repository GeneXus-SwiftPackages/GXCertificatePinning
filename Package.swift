...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.19.xcframework.zip",
			checksum: "a7e2269f36a3e62de9f0572f33c6116587389ff2edbe57f6521c0118c4907f8e"
		)
	]
)