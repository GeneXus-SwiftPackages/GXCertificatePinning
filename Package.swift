...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.1.4.xcframework.zip",
			checksum: "e506e12471ad164f3db6064430d61ecf2b80fd4ce8528518e48b1e90a72bf12d"
		)
	]
)