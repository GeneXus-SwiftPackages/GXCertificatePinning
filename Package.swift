...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.2.0-rc.10.xcframework.zip",
			checksum: "c03525496e9c97c27330a150fc4e33ab148c037ed062584447153d43cc5272ef"
		)
	]
)