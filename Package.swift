...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.16.xcframework.zip",
			checksum: "6b0bf8a112419438851774fdeeec21924719e4ea1d561d214ee40dbb75657952"
		)
	]
)