...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.10.xcframework.zip",
			checksum: "3f902eee78f4c9623f504d2caf9abc2d401af93954e8720b2859e4f14ff2b571"
		)
	]
)