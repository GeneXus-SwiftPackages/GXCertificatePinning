...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.12.xcframework.zip",
			checksum: "3b109db3009d0fe339c4e4e1a8f40afa0d6bd68760a02c06dbda54fcbb8d1e6c"
		)
	]
)