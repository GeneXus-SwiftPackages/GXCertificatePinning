...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.19.xcframework.zip",
			checksum: "d6f341d200d18fd4dcbf7e12fdc5e2b25aea99b5c26ef88fcae2dd8e862f2147"
		)
	]
)