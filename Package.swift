...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.2.0-rc.37.xcframework.zip",
			checksum: "54204a64b889c2d28f8f19c499d8d8b726fbeb5952eff659f66417681456e594"
		)
	]
)