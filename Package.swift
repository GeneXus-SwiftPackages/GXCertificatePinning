...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.17.xcframework.zip",
			checksum: "d8cfcfa52d095ac2899c1bf377ff97e2ff17543a71643f215270d1e090ef0ab8"
		)
	]
)