...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.3.0-beta.5.xcframework.zip",
			checksum: "365c58b2f232743f441fe1dd525bcd0004d6e0d1c463490af3f7904b33b3980d"
		)
	]
)