...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.1.2.xcframework.zip",
			checksum: "53be354aec848c28cbc07949c4acfb47e724370d860b611566e1fa241391dfcb"
		)
	]
)