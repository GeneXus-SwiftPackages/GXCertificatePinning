...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.23.xcframework.zip",
			checksum: "a6e85f41e235e1f1774806cc2c64eeadf5c86c5ae0533acc1ef24cbb683faa34"
		)
	]
)