...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.11.xcframework.zip",
			checksum: "7ddbd015fdb7055397b90924f4368b0c8db9aa80b72dff5b4512bc90a6360464"
		)
	]
)