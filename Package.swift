...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.0.0-beta.45.xcframework.zip",
			checksum: "3852462f0e893a224c35ebedd41f37bc6723ac06d16eba171e70be5abd02c6c7"
		)
	]
)