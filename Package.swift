...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.12.xcframework.zip",
			checksum: "604756d38e312714dc4ed3d421ad8aec3e27675d8f3a930d6b256459c5c84905"
		)
	]
)