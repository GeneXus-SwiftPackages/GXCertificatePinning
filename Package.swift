...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.15.xcframework.zip",
			checksum: "9e09410b82654218a41a48245bc5971e00049ecce15af40a0596faa62bc27080"
		)
	]
)