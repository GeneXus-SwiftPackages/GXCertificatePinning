...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.1.0-beta.7.xcframework.zip",
			checksum: "e519c7a3423aca9346aeda5014788aad25edaafd68a76a9053e1a7aae4fe6f9f"
		)
	]
)