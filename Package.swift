...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.37.xcframework.zip",
			checksum: "0ab3dfb814015eddafc9888f0dde577f28f818ec9046386950504b02bc382beb"
		)
	]
)