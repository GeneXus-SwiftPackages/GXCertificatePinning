...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.2.0-rc.9.xcframework.zip",
			checksum: "38a9bea738899f1db137c0ae2d9f21203b95bffa5549e81e3f8b1169d90d0247"
		)
	]
)