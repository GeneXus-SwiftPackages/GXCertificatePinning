...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.6.xcframework.zip",
			checksum: "586e089edfbafa252f297f24806acda9fcea1331c3399e24c4cc06d84d5d2413"
		)
	]
)