...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.18.xcframework.zip",
			checksum: "46e4b339209c24f6b5de5e0841bb5ea6eada0a02700f16d82a842d44866f7660"
		)
	]
)