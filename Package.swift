...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.1.0-rc.24.xcframework.zip",
			checksum: "340bd2462230b8cb2e5c4d585ab052bf02301eac3b35f0dfdf19ae42f2a48eb1"
		)
	]
)