...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.12.xcframework.zip",
			checksum: "ee8b6ee8f26f16b3e2816d5f1df3fc17bfeb6f791dd2fafd5bfb988293b21e71"
		)
	]
)