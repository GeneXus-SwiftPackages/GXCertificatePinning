...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.2.xcframework.zip",
			checksum: "7aea070d47b8f1e03dbf3fd5d69521e465951832d98fd04193566709bea779ca"
		)
	]
)