...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230503140111.xcframework.zip",
			checksum: "0862a74348e8554acf44b4e57fdec36c9b9cd639e256bb66cc3b593ddae63b16"
		)
	]
)