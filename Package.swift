...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.36.xcframework.zip",
			checksum: "6814e26de987d96ba6f09a18aa9f3c3495bd383e51b8684612e36592ef70d4bc"
		)
	]
)