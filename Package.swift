...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.36.xcframework.zip",
			checksum: "0977dc4a0ba3b7427bc79e6edc90fcccdab1bc8530d957c6f30505fd68f18263"
		)
	]
)