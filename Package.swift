...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.25.xcframework.zip",
			checksum: "549b0716410019c479bc339d6ac128fb51d8187b1b54c9ab58e237cca2a5e895"
		)
	]
)