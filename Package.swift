...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.11.xcframework.zip",
			checksum: "d9099260a07c2e146b85311059b339702d1ab9739e0b0cb44c44573bcb9aa2f9"
		)
	]
)