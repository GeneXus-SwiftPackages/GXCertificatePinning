...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.21.xcframework.zip",
			checksum: "206ed88623fa2524b5ca6b9124d545f774eddb760515a6e1c2a9f015b68e649a"
		)
	]
)