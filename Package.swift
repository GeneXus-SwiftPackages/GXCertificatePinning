...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.27.xcframework.zip",
			checksum: "a13be6ec124b7434133700c151cf474adbd0f050dfc6a3475723c46008c15bad"
		)
	]
)