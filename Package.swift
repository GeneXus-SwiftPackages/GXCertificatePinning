...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.3.0-rc.13.xcframework.zip",
			checksum: "179da02fdb114204f63d30313a777269fd6882653a7abe8977a4dbf3998b028d"
		)
	]
)