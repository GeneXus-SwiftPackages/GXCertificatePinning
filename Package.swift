...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.5.12.xcframework.zip",
			checksum: "4c4cd2ebc1fb5c82a89be56a4a138a57228c05f497441cf6864da5f3b23369c3"
		)
	]
)