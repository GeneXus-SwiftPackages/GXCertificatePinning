...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.12.xcframework.zip",
			checksum: "1da4c1532dc4dc978a6ab7eed45eed89b399c8ccac3cea650a9818deb93fe806"
		)
	]
)