...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.1.5.xcframework.zip",
			checksum: "b89cbff61f45956fa33ea758e23b18a270439d30665b5de8d0299fae1453b559"
		)
	]
)