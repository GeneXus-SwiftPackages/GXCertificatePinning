...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.0.6.xcframework.zip",
			checksum: "5d82c99c4c3d4d078740e6ad1877a4ea2e3d57e635e06cd000e761f9be8635d4"
		)
	]
)