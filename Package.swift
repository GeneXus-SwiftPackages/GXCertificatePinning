...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.5.xcframework.zip",
			checksum: "1ead685656cf1478d97a35fa9306d76a6e0bad25695281367b2ee88ddb1ca18d"
		)
	]
)