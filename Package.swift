...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.41.xcframework.zip",
			checksum: "9531aaa5dd160a3aecb3b91e9833de5ea5409a86191e914eb3b4e455b5d727d9"
		)
	]
)