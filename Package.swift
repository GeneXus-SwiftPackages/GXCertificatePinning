...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-5.0.0-beta.1.xcframework.zip",
			checksum: "22a11332f84a4573c1154f6b866748a4bf5847e69cd9c58ced147bc6d86fc816"
		)
	]
)