...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.14.xcframework.zip",
			checksum: "e1d3d2e143336c7a646bbb6e20eb7189dad90074d08572835a3116e024301ac5"
		)
	]
)