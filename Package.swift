...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.21.xcframework.zip",
			checksum: "e47b1b9114bf16556e79133911cfcc0d41c63f2d55be790a188e09f4deaf1f57"
		)
	]
)