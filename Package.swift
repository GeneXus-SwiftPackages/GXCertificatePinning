...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230509202229.xcframework.zip",
			checksum: "5a95411fde2bcf2501b3c5f1d7a292789e80d7a915c29f538c89137a2c800b2e"
		)
	]
)