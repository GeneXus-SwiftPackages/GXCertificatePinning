...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.32.xcframework.zip",
			checksum: "c6430d06a9e5c928df615d0a9f2528e808ea215a83abe137914e99798135c47b"
		)
	]
)