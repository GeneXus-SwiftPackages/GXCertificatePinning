...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.5.11.xcframework.zip",
			checksum: "5682dbb664753575a969e831bcccc02fd3cae1f59bf78e8542a3b06c36c9fbc4"
		)
	]
)