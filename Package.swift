...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.38.xcframework.zip",
			checksum: "9914adf91d715ed0ba27417da0c8b26c995238a731031883d78cc251b88588a7"
		)
	]
)