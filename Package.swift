...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.9.xcframework.zip",
			checksum: "22df93bde318d11624cf2167726d9d368c833d858a48c71339478d503991c659"
		)
	]
)