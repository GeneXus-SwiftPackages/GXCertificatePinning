...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.33.xcframework.zip",
			checksum: "035810c964e299f5a533efbef110aee792955ef67ec2dbaa66db1c9d0f64a7b7"
		)
	]
)