...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-3.0.4.xcframework.zip",
			checksum: "bece208f98c19598388a6b4dff6d535df83d95b17c06a65792b5dfb9f25b769d"
		)
	]
)