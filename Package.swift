...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.9.xcframework.zip",
			checksum: "7fe78e40967b5b9d9e498afe646ba22a59d0dd3ca5e0c76b778b94d27fb5800d"
		)
	]
)