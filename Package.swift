...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.14.xcframework.zip",
			checksum: "805f9d1f7d4f8b7dc1481e6d59b42398a4c9cb66fce4a29361faac2bdbc1bc21"
		)
	]
)