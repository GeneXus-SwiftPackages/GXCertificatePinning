...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.37.xcframework.zip",
			checksum: "d2f5db0e7b41311a7ddabfd85e373bc02fa6e73ad1c4680f8b678eeeafa70763"
		)
	]
)