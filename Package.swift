...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.25.xcframework.zip",
			checksum: "04a17a825a992876c26cc1d1127e93357b5f3317aeca6e7e456a68f36ccc7877"
		)
	]
)