...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.34.xcframework.zip",
			checksum: "1862b02657d03d76eb373d49ae3022e501f4b46e0d3892761c02feb7520788ae"
		)
	]
)