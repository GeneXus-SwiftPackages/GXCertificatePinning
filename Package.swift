...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.2.0.xcframework.zip",
			checksum: "1ec1250a22de84035eff244caf19f8c2e0671b0fd613b669f2ffc00805bec6cb"
		)
	]
)