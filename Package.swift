...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.40.xcframework.zip",
			checksum: "1aacf4e3f28506eb40c2448fce5f9ea4066933c9a86ddfa7c280f2dfea2933f9"
		)
	]
)