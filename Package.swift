...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.11.xcframework.zip",
			checksum: "8c2b606a2a3a313421826d7e94c449ccc4d409f095023b3cec2595e693b9cb19"
		)
	]
)