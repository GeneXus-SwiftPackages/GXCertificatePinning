...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.16.xcframework.zip",
			checksum: "f28a7659f582928ade9b432fc56e0febeab63d119ba0446aae0fb36dba4c03fc"
		)
	]
)