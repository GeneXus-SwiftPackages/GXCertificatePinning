...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.8.xcframework.zip",
			checksum: "d76060398ab902b283706c2170e6af6fe8559e9a444b88726525d35523f8bcf6"
		)
	]
)