...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.4.26.xcframework.zip",
			checksum: "68b820a07913e2e8c38180a7beb27814c6c914fb63fea986d217d35bb8701dc5"
		)
	]
)