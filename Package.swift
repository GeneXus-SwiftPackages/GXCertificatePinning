...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.19.xcframework.zip",
			checksum: "2984cf9b02382d443d93d6cc80a06c1c4842923a5029a4f7c722d2b99c31c1fd"
		)
	]
)