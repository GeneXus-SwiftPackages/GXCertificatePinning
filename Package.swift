...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.20.xcframework.zip",
			checksum: "ab2fbfce4cd3c22c77b6e864a6abac1e42165fb0b52f58261987052e8be7ba67"
		)
	]
)