...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.20.xcframework.zip",
			checksum: "336d760a7765488dc7d93f6d1bbbd3ca42925b6a02ba1a3cd83b1da45c5d129f"
		)
	]
)