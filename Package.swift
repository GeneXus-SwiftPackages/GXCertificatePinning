...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.20.xcframework.zip",
			checksum: "44871c2cc140ed122df42934ff90ad9e9223195226518c90e3444b463878e89e"
		)
	]
)