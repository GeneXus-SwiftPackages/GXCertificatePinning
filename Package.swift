...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.3.0-beta.2.xcframework.zip",
			checksum: "ab61dff918be315707721dde391db59df75440384406ba31f0aa20302c82e3c1"
		)
	]
)