...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.6.0-beta.3.xcframework.zip",
			checksum: "35599158d19a3e63008155f0f34e9c6ed03a84cf7d0f7b89cf724986c1fec8b0"
		)
	]
)