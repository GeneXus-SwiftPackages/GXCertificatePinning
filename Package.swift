...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.10.xcframework.zip",
			checksum: "423e9b3e7771b488f35e2ba6b5948ddcaee34cbff367eba86d80e9751f051e45"
		)
	]
)