...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.17.xcframework.zip",
			checksum: "42036a7ad3d0a544ac0e66b239b4f516d3b7a5e69d1fde2d32a434e5e2f425e8"
		)
	]
)