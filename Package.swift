...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-2.0.0-rc.32.xcframework.zip",
			checksum: "49e78b1f73b784cd7f88910d0c91221f587a6d6ea1693b0da51342b09307b163"
		)
	]
)