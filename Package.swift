...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.12.xcframework.zip",
			checksum: "8798bf9f3d034936915c9cd056c00c5a293ec416e3c0a53f99c5c4c505628bac"
		)
	]
)