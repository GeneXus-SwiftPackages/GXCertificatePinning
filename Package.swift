...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.18.xcframework.zip",
			checksum: "89153fa743f0a1465d71c7cebb3c67d264b3420eb08a2b716ef85848e97d0091"
		)
	]
)