...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-2.0.17.xcframework.zip",
			checksum: "2f44b63f8f43a24ed8181a083e04b947e9d0787341e26cfde6c38bcd18bb012d"
		)
	]
)