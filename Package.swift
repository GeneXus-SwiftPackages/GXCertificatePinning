...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.6.xcframework.zip",
			checksum: "2667a4bbb2e50ca042314740ceec0841a4170fb1774454fdb2996e08e860d241"
		)
	]
)