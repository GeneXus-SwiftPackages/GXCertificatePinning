...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-2.2.0-rc.3.xcframework.zip",
			checksum: "8aa915d0b708f3183be138939e243fdec75ea2157568d7e858708e3bea5a242f"
		)
	]
)