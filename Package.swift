...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.10.xcframework.zip",
			checksum: "f75a5b2275e35a6ea1a61cadcb814d639fc76dcdde3767c35332a8f9e60accfe"
		)
	]
)