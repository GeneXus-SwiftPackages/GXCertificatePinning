...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.17.xcframework.zip",
			checksum: "b44ef9cf5f2150a6affdb702a477aebd752ecc6c1f856868527a39edd13ff595"
		)
	]
)