...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.15.xcframework.zip",
			checksum: "fcc5f294e04416de93171f96ccd101fe1a59ca45659fb30b2a942b367418fce4"
		)
	]
)