...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-2.1.0-rc.25.xcframework.zip",
			checksum: "74f0dd3c5bb1c2a8af4e36fa5988022948ba6e3b30da5267568975bbd868830f"
		)
	]
)