...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.0.0-beta.44.xcframework.zip",
			checksum: "065686fa20fdf649a6c43f5a23af0821cb277c16e71c66208891e535b35c7379"
		)
	]
)