...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230503131704.xcframework.zip",
			checksum: "cbf2dd657324b2f6123c49472c31b8060a5f1aa6f6ea72774a279904e23a2b78"
		)
	]
)