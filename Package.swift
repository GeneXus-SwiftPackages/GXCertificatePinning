...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.8.xcframework.zip",
			checksum: "32c999ab8b951360369a509f125490fd0bd71283645da268260917aabac1b772"
		)
	]
)