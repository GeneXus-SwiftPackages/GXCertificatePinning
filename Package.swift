...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230424185248.xcframework.zip",
			checksum: "96986871809ea36955ffc790199cb78d16543aea04ef2f1ff82518ceb01bfd53"
		)
	]
)