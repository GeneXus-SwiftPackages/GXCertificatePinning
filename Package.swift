...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.4.xcframework.zip",
			checksum: "176be1fecbf7748cdc6995c08c3e161f7e66abf6ae60ed76bea30a1064911992"
		)
	]
)