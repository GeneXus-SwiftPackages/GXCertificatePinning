...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.38.xcframework.zip",
			checksum: "fab19929d67f2caf8e61b0bb80898567ff6745ad661ce28c58102afad16137a0"
		)
	]
)