...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.17.xcframework.zip",
			checksum: "a1180a3fd670c829dc1c398ebefb88cfd9822d14ca5c1c10ba5aefdbaeb04c82"
		)
	]
)