...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.2.0-rc.34.xcframework.zip",
			checksum: "a3c314c38bea178908dbdd3d4f9756905b3ed9e44c254fddf991f6ca15225be1"
		)
	]
)