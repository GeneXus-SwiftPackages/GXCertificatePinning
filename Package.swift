...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.21.xcframework.zip",
			checksum: "28057e8f33fc7fc9bc023e8cf95d2a1df65ebd4bc099f5f8f70474e98573db91"
		)
	]
)