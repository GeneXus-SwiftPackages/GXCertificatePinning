...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.2.1.xcframework.zip",
			checksum: "addb5b00b531134cdba229d978c9f737b0e7b3b89393563b6253bf46a47229b6"
		)
	]
)