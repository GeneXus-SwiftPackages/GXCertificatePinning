...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.5.xcframework.zip",
			checksum: "8dc8bca4fd102de50450ea66c19d114f2a0ebff90daaccdaa31871eaf51705a8"
		)
	]
)