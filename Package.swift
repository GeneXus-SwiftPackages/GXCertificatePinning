...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.27.xcframework.zip",
			checksum: "a6cfec39bf4494736a9cde155726fb1515aac0ef3cd417a267619af9895766ba"
		)
	]
)