...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.1.0-rc.4.xcframework.zip",
			checksum: "8057ec4d6323575f78d02b434e231f3e9a71d202ec0c7bb600b51803ee6c72a1"
		)
	]
)