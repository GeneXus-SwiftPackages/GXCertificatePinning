...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.25.xcframework.zip",
			checksum: "d7aabafb1118100bf2bcb060246551bfdb548fde6c651e4a851b024d29059a9c"
		)
	]
)