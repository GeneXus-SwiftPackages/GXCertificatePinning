...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.2.0-rc.20.xcframework.zip",
			checksum: "01b2c6b30290e2142dffa5329acb835577ad472af94e4bee61b589fcf13c2b9a"
		)
	]
)