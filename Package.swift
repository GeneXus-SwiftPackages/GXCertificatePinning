...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.6.0-beta.1.xcframework.zip",
			checksum: "b77c2bf0cf36e1d1e54269ad188e04e8273dd7e19d575cc41a64346ca6a3e030"
		)
	]
)