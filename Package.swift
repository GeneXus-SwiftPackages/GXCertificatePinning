...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-2.1.3.xcframework.zip",
			checksum: "3d31330ed69659bfa15f9eb961dabbc4a2a72cec0079478f5332ca5ae5452c9e"
		)
	]
)