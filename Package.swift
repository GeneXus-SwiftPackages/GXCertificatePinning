...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.1.0-rc.8.xcframework.zip",
			checksum: "e6af10564adb7e74a7ee7d69f20041ee5714f890135480c5f2c9a492ead61746"
		)
	]
)