...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.24.xcframework.zip",
			checksum: "b2e49637d6938ab20285c16ed3e6b4a90540f5c6be2e5407450e6956a22e7645"
		)
	]
)