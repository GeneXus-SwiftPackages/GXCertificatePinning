...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.24.xcframework.zip",
			checksum: "3c16338817e42413a93647b126bfda9f265dd8957a98667ccde6a1ae67576198"
		)
	]
)