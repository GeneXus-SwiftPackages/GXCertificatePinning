...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.27.xcframework.zip",
			checksum: "c7051902e211a39441f9421446762ea5589026dec0572a0e0d8cb79c56db628b"
		)
	]
)