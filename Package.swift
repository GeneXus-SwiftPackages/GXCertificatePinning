...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.11.xcframework.zip",
			checksum: "71f51f21361a34c7fad332c388787d3432a7c4d259128c325882144cc8d13d86"
		)
	]
)