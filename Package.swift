...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.1.0-rc.3.xcframework.zip",
			checksum: "22737649eeabd275f1ab1f5dd191a56d825c1d06ee37950417b8d29c41bd6630"
		)
	]
)