...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.10.xcframework.zip",
			checksum: "e836238bcddea9bd864352432e2c3fa6665fd17defa80c83968936d83c4b8a9f"
		)
	]
)