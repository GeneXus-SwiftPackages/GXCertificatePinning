...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.2.0-rc.13.xcframework.zip",
			checksum: "38b0f2f2d18fee93bd64e4b8ea608c3f0ab829812f5abd421849e8fd0af3d446"
		)
	]
)