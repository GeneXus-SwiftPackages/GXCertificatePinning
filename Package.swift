...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.3.xcframework.zip",
			checksum: "4e9062e0635ddf0ed6e80a0138ca6b454916edfddcd69ce4b736b2d9ad294c35"
		)
	]
)