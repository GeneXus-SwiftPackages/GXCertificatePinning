...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.23.xcframework.zip",
			checksum: "2ea4ed6acbf822ea4cd5b55eb33fd9d3d7a7e2a33524162888171a989ea61f89"
		)
	]
)