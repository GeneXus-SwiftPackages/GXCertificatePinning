...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230504210908.xcframework.zip",
			checksum: "3d1ef93263f4ef0d72a3eddd5689fcef87b02af61a384daa31bf15894dd7107a"
		)
	]
)