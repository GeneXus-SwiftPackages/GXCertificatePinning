...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.26.xcframework.zip",
			checksum: "c1c3c5a478fdc6316e5e466a14399d81d4b258e7d4e717c85aee671abb58564b"
		)
	]
)