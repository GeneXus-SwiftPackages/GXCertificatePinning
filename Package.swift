...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.35.xcframework.zip",
			checksum: "ea562a76c5ce2de296ca1b37ec697630fbb85de2e5e7fbba4043e6aa2cde2ba7"
		)
	]
)