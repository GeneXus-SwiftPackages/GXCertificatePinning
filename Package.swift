...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.20.xcframework.zip",
			checksum: "34ff44ec2eabdaf49ac504f251185a9ef40bd79d4bd7b7a63e975d4f7d86005c"
		)
	]
)