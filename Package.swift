...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.37.xcframework.zip",
			checksum: "4b0dd6a0c030ba4be5e7eb4d7fad9866e6f80ce8e0ac28ae0b3b82b08389aa7f"
		)
	]
)