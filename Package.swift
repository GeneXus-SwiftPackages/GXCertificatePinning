...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.31.xcframework.zip",
			checksum: "3632fd862dad76f6a53c0bd5168969c71fab6506c0535f57035dc67a74dafbf4"
		)
	]
)