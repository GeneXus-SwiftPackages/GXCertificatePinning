...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.15.xcframework.zip",
			checksum: "f54eb76126c0d77d84bef1a3bd1d807c8cd10bb68882d88b46234452e44e7ef0"
		)
	]
)