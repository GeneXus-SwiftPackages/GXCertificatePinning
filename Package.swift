...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.33.xcframework.zip",
			checksum: "f12e44f97feb6e004178a15062f3a26ba20b323df7e23764fdd66bde4b986fb9"
		)
	]
)