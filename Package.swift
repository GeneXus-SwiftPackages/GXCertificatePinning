...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.6.0-rc.0.xcframework.zip",
			checksum: "cae2fc62bc826498b2c0c195027cb79059a85a428fe5d5fbf048d24a0626a60c"
		)
	]
)