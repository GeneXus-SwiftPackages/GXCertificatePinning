...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.20.xcframework.zip",
			checksum: "e818a89a8fda2837da4ea64ef26f69d5d136bb85a6f778ac8c894022aa673aea"
		)
	]
)