...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-3.2.0-rc.13.xcframework.zip",
			checksum: "aa9cc0a6882c01c850ca2fbf9e171fdd70df2a02d4d6016b24b20894c8210307"
		)
	]
)