...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.5.16.xcframework.zip",
			checksum: "66237a502f7ec95a19ff0573355b3987878d612a1bff7f69351a1bda825ff5d3"
		)
	]
)