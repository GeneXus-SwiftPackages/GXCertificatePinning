...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.14.xcframework.zip",
			checksum: "a39cfc8da9882b431fc9072735c2e04f6ec58807d679c507b485134f671ba3d9"
		)
	]
)