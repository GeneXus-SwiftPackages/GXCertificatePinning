...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.4.30.xcframework.zip",
			checksum: "30dd04465cfcd4df64bb5374f08280a28475375ad83254d16086c9f9660b4d6a"
		)
	]
)