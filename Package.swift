...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-5.0.0-beta.5.xcframework.zip",
			checksum: "247c4bbd6710264df8613335951f9481bac063d8e56c06b2762bb7cfe3048942"
		)
	]
)