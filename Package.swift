...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.8.xcframework.zip",
			checksum: "cc805cfdf9288de971fa1861642d88ca298074983d7030f2de46937ed9595305"
		)
	]
)