...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.1.0-rc.25.xcframework.zip",
			checksum: "cbd48b6f758bcc5029803b88fd228b260b3b7073ccd343e81e0012da10d0d439"
		)
	]
)