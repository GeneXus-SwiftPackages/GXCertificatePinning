...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.0.3.xcframework.zip",
			checksum: "a39f65003e396a9e959deac8675ee1c0f3c2b62540abcca8f765f579dabbd2f8"
		)
	]
)