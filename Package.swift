...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.8.xcframework.zip",
			checksum: "ac9ee545993c409f05960b3e063392e5803620c99d1bf4bf5ac077ce93b7a27c"
		)
	]
)