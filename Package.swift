...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.1.0.xcframework.zip",
			checksum: "7ceddf830d6af7e9394a611ef96c16d0bad5c20a0e84e170a798b6b7c930e628"
		)
	]
)