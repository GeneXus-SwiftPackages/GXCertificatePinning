...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.10.xcframework.zip",
			checksum: "2599bc156bd3cc1e920ac806dd99027d404d30b2e14f8ca91a179bc2f197f332"
		)
	]
)