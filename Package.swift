...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.0.0-beta.2.xcframework.zip",
			checksum: "05d49954c776f6ecfd7f701289a6fe12b95256a032dd805edf6ce13d4b10fc6b"
		)
	]
)