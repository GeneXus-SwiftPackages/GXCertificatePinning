...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.31.xcframework.zip",
			checksum: "9ac701a764ac32d05f7d4f31dc0969228f1897e5f89bfcbd1053f795f4b32616"
		)
	]
)