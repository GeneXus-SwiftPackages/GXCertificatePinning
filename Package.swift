...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.34.xcframework.zip",
			checksum: "667bae06cbc66526a99a8e4d6bc7226f1681d7c6507ce6feb63a74c17732893e"
		)
	]
)