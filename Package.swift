...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.12.xcframework.zip",
			checksum: "175771f67a7d7ddd424f7f2e7d765738290cb5d882cd6a4f74962aedbdd1937a"
		)
	]
)