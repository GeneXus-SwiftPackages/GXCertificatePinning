...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-2.0.0-rc.22.xcframework.zip",
			checksum: "1cd4dd319eb634aca77b0859d92c9d7c02da0c6422de3bc19efef6a1c0f45626"
		)
	]
)