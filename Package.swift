...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.3.3.xcframework.zip",
			checksum: "fa120fb66a804da729cbe54d02ca54246eb886214d438db7195395f601661162"
		)
	]
)