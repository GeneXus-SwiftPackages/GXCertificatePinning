...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.41.xcframework.zip",
			checksum: "e572617c50b45c0206a365e662a60af06f16fdf9f36266ba8c378c3591d010cb"
		)
	]
)