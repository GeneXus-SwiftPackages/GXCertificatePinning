...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "9a8e7050b79806b982129773ccd2224dc8ebd9fd615d6c2a170b200669f90287"
		)
	]
)