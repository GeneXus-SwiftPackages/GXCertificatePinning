...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.1.3.xcframework.zip",
			checksum: "80cb4cbb688df8306351257fedbad63902be2ccb7ed6535550e55e10560495de"
		)
	]
)