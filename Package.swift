...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.1.0-beta.23.xcframework.zip",
			checksum: "208b7e22651a5253d0c41cf2efcd126972c25526d9fbfa2190339c3cb1248b9e"
		)
	]
)