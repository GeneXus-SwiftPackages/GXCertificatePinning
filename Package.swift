...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.13.xcframework.zip",
			checksum: "06180ee9523a163f5563a11f4b681377295c2c2c2aeb21316269752d13be8c8c"
		)
	]
)