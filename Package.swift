...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.0.0-beta.51.xcframework.zip",
			checksum: "b6bc3af49c0a3e062ff89221bf1b6fa475d247bb626ed4dd455558af49559bec"
		)
	]
)