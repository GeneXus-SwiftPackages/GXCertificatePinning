...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.26.xcframework.zip",
			checksum: "3848be350e7c217c12c8aacbf0f120b7ff4ea3082058bab1d17db54065a3b74e"
		)
	]
)