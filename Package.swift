...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.29.xcframework.zip",
			checksum: "e0a5906012229bbf4e4c6354d8f285d6f1fbe4351e874785ef2bea77343d1819"
		)
	]
)