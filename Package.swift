...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.3.0-rc.7.xcframework.zip",
			checksum: "e850b0e99d8145ca5fe0580488f9eebb9c209890f66b59b9d81e3ed4986fdb6d"
		)
	]
)