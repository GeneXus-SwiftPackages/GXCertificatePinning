...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.17.xcframework.zip",
			checksum: "9255abef9a517751b9ebfdb0ea4adfb1fdc1a31b1c150cc8534846031c45d3db"
		)
	]
)