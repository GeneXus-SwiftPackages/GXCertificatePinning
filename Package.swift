...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.31.xcframework.zip",
			checksum: "ddbf5e09c834644fc6b45822e4484643c0faeec8f4735553856ab5c9316671dc"
		)
	]
)