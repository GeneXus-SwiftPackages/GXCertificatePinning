...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.1.0-beta.795.xcframework.zip",
			checksum: "78007fc1d336147c7a1abfcd1c3ffe40f61b4531ac8e9d62302ba4e16802b937"
		)
	]
)