...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.18.xcframework.zip",
			checksum: "01614d673e88fa36a7ae52ca6f95be10c738f45a6fd3e11a8d7cf07a3f868e27"
		)
	]
)