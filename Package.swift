...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.2.0-beta.16.xcframework.zip",
			checksum: "3b53749812c19783666c3d6d92d3e8aff6e10a254e6d4b2011ebeb6b34023151"
		)
	]
)