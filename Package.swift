...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.0.0-beta+20230515145153.xcframework.zip",
			checksum: "14c522398b01715f5c9366a39dced0708f85f63acb3a24946726f0d74edf9665"
		)
	]
)