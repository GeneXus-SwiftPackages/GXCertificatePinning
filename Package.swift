...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.0.2.xcframework.zip",
			checksum: "979f21f4eeb55f06de01e6954d506b69b2e547ee160edf00cdf2bfe98fa0edfb"
		)
	]
)