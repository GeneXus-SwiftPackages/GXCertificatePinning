...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.1.0-beta.794.xcframework.zip",
			checksum: "4f632c5403d73670bab107cab8f10440d3752cf5be3f37c8e4b7dc0085e4f9bf"
		)
	]
)