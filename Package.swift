...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.15.xcframework.zip",
			checksum: "a36b7b65a61a2e2caca999c53a5e487913813683b75c8307bd9c561f53ee359f"
		)
	]
)