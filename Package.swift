...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.0.7.xcframework.zip",
			checksum: "56e492866194243c9f3e886664e00898d08f4a63ba295b22944c02e1ce9430df"
		)
	]
)