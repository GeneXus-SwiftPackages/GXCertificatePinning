...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.7.xcframework.zip",
			checksum: "3bd7add10ca7afbae863d1a677f780c696c78b7473afd240354e06755ad7375f"
		)
	]
)