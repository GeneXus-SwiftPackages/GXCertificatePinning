...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.7.xcframework.zip",
			checksum: "423f010c46f2413ead61d4a06d0f043f4c23ac4250d30c3d2a53b325eab7fc76"
		)
	]
)