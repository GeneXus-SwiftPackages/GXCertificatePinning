...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.30.xcframework.zip",
			checksum: "400ee8cbaa817e5bdeaa452ff31fa8e72f6cb9e429f46e73695b190daeaf6bc3"
		)
	]
)