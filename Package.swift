...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.25.xcframework.zip",
			checksum: "4198852330aac4b0789c3c662695b6c817bcf68c7efda1c1a198f6c07a75bef6"
		)
	]
)