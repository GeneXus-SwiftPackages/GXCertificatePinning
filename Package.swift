...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.25.xcframework.zip",
			checksum: "8ee567923108a92a02ab7389f70fec03dee3277901994ecc64739727a85f4e04"
		)
	]
)