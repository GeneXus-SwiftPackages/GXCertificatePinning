...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.1.0-beta.4.xcframework.zip",
			checksum: "d54843c04c8ba938db7e6d046b74010a8f009743b183e6a68a74ba812f7ca417"
		)
	]
)