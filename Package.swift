...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-4.2.0-beta.38.xcframework.zip",
			checksum: "12dcdab39ae3adef637e63062b7e99f85f4379d348d7b114874e0ebd37549c6f"
		)
	]
)