...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-1.2.2.xcframework.zip",
			checksum: "44f1bd0294e8fd3e88f01e7ea22f1d8f8a62fde222614f37d6be71af5d803115"
		)
	]
)