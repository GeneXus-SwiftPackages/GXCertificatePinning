...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-4.1.3.xcframework.zip",
			checksum: "fc3492e9bad9fabae126ccc1bcff92cab6e25df15ca80a5df852bc08dfe45c59"
		)
	]
)