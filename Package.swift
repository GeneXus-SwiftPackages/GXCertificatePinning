...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.3.xcframework.zip",
			checksum: "a34a725db17ea66c9d36bb559596408b3d2bffbedafa9748de7ce07841824899"
		)
	]
)