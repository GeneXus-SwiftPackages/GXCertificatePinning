...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.27.xcframework.zip",
			checksum: "77f5e155b83391ff5375534e14291cfc3c8f2a2c427751fa5911d6cedfac9ae9"
		)
	]
)