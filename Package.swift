...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.27.xcframework.zip",
			checksum: "2cb6a29a1b8b25bc4c684bb0ed929ad8dd920ce1ea460d854de752bee82f9d37"
		)
	]
)