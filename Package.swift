...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.3.0-beta.11.xcframework.zip",
			checksum: "b2cacc191d5982d43c6c17b69d1c57ee78c6e9f652242a16e0a961669e8bba2d"
		)
	]
)