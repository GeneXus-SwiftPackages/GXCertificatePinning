...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.5.0-rc.2.xcframework.zip",
			checksum: "85fd672f7681bdb65f50c5e4473f625adb3151c0b34b7234e4a350050278ea1f"
		)
	]
)