...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-1.2.0-rc.15.xcframework.zip",
			checksum: "875b2a8eef8713f5f33edf2640af671bd9f07a8f918f46e9b91409c89aff2fd5"
		)
	]
)