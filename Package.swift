...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.0.0-beta.5.xcframework.zip",
			checksum: "cbe5be4ac466e5920baafe3cce5cf4ba82816f4508a8ab749f4a59f6148eba27"
		)
	]
)