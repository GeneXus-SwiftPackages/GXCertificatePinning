...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCertificatePinning-2.0.12.xcframework.zip",
			checksum: "9a06ce81f56f3f29b1697733e9657e1b97d980b932ce2625ca293e0b66d7e988"
		)
	]
)