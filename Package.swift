...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCertificatePinning-4.1.0-rc.14.xcframework.zip",
			checksum: "3af7e35393277c29b0603995c0891b6be9ed1edf4a47f008732188f5d777b703"
		)
	]
)