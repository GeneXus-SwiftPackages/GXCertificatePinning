...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.1.0-beta.25.xcframework.zip",
			checksum: "02d405951a2a6e6b59a40c7c38df0534adf2c798483498b03a7de8f7381dc001"
		)
	]
)