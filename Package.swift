...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.32.xcframework.zip",
			checksum: "5e0bd7d4688de988b1a571dfa9fad6d29f970b3b177f9e65dd668c044d63ea04"
		)
	]
)