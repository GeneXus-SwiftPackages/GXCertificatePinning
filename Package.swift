...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.6.0-beta.0.xcframework.zip",
			checksum: "6b5149e08025a1122f16e69d0a5fd70187213bac230a9961606e9fac131c6baf"
		)
	]
)