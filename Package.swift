...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.5.0-beta.28.xcframework.zip",
			checksum: "b57df7247dd55099ee97dbe84b580cb027d14e92cd704e53865071c26095e8b5"
		)
	]
)