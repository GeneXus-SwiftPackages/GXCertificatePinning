...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-2.2.0-beta.18.xcframework.zip",
			checksum: "6ccd2b11caa67f081d388d0ec9ca536b63cc6108c1ac85bae4ad9f399828e352"
		)
	]
)