...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-1.4.0-beta.12.xcframework.zip",
			checksum: "023bd792f47bf40501c01d72ecd559bdb484d53af7bf4814479f83ad0824248f"
		)
	]
)