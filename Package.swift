...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCertificatePinning",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCertificatePinning-3.2.0-beta.20.xcframework.zip",
			checksum: "d49e7e559ec36fe2c1edd0d3611d6759eb41919a087cab06934f5bf4b65e47fa"
		)
	]
)